...
void initializeDefaultScene (out STriangle triangles[12], out SSphere spheres[2])
{
	...
	cube.bounds[0].v1 = vec3(2.0,2.0,3.0);
	cube.bounds[0].v2 = vec3(2.0,2.5,3.0);
	cube.bounds[0].v3 = vec3(2.0,2.0,2.5);
	cube.bounds[0].MaterialIdx = 7;
	
	cube.bounds[1].v1 = vec3(2.0,2.5,2.5);
	cube.bounds[1].v2 = vec3(2.0,2.5,3.0);
	cube.bounds[1].v3 = vec3(2.0,2.0,2.5);
	cube.bounds[1].MaterialIdx = 7;

	cube.bounds[2].v1 = vec3(2.0,2.0,3.0);
	cube.bounds[2].v2 = vec3(2.0,2.5,3.0);
	cube.bounds[2].v3 = vec3(2.5,2.0,3.0);
	cube.bounds[2].MaterialIdx = 7;
	
	cube.bounds[3].v1 = vec3(2.5,2.5,3.0);
	cube.bounds[3].v2 = vec3(2.0,2.5,3.0);
	cube.bounds[3].v3 = vec3(2.5,2.0,3.0);
	cube.bounds[3].MaterialIdx = 7;
	
	cube.bounds[4].v1 = vec3(2.5,2.5,2.5);
	cube.bounds[4].v2 = vec3(2.0,2.5,2.5);
	cube.bounds[4].v3 = vec3(2.0,2.5,3.0);
	cube.bounds[4].MaterialIdx = 7;
	
	cube.bounds[5].v1 = vec3(2.5,2.5,2.5);
	cube.bounds[5].v2 = vec3(2.5,2.5,3.0);
	cube.bounds[5].v3 = vec3(2.0,2.5,3.0);
	cube.bounds[5].MaterialIdx = 7;
	
	cube.bounds[6].v1 = vec3(2.5,2.5,2.5);
	cube.bounds[6].v2 = vec3(2.5,2.5,3.0);
	cube.bounds[6].v3 = vec3(2.5,2.0,2.5);
	cube.bounds[6].MaterialIdx = 7;
	
	cube.bounds[7].v1 = vec3(2.5,2.0,3.0);
	cube.bounds[7].v2 = vec3(2.5,2.5,3.0);
	cube.bounds[7].v3 = vec3(2.5,2.0,2.5);
	cube.bounds[7].MaterialIdx = 7;
	
	cube.bounds[8].v1 = vec3(2.0,2.0,3.0);
	cube.bounds[8].v2 = vec3(2.0,2.0,2.5);
	cube.bounds[8].v3 = vec3(2.5,2.0,2.5);
	cube.bounds[8].MaterialIdx = 7;

	cube.bounds[9].v1 = vec3(2.0,2.0,3.0);
	cube.bounds[9].v2 = vec3(2.5,2.0,3.0);
	cube.bounds[9].v3 = vec3(2.5,2.0,2.5);
	cube.bounds[9].MaterialIdx = 7;
	
	cube.bounds[10].v1 = vec3(2.0,2.5,2.5);
	cube.bounds[10].v2 = vec3(2.5,2.5,2.5);
	cube.bounds[10].v3 = vec3(2.0,2.0,2.5);
	cube.bounds[10].MaterialIdx = 7;
	
	cube.bounds[11].v1 = vec3(2.5,2.0,2.5);
	cube.bounds[11].v2 = vec3(2.5,2.5,2.5);
	cube.bounds[11].v3 = vec3(2.0,2.0,2.5);
...
void initializeDefaultLightMaterials(out SLight light, out SMaterial materials[8]) 
{
	...
	materials[3].Color = vec3(2.0, 2.0, 2.0);  
	...
	materials[5].Color = vec3(1.5, 1.5, 1.5);  
